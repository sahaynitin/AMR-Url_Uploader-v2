...
async def save_photo(bot, update):
    ...
    if update.media_group_id is not None:
        ...
        await bot.send_message(
            ...
            text=Translation.THUMBNAIL_SAVED,
            reply_to_message_id=update.message_id
        )


@Client.on_message(filters.private & filters.command(["sthumbnail"]))
async def show_thumb(bot, update):
    ...
    if thumb_image_path is not None:
         await bot.send_photo(
               ...
               caption=Translation.CURRENT_THUMBNAIL,
               reply_to_message_id=update.message_id)
         ...
         await bot.send_message(
               chat_id=update.chat.id,
               text=Translation.NO_THUMBNAIL_FOUND,
               reply_to_message_id=update.message_id)


@Client.on_message(filters.private & filters.command(["dthumbnail"]))
async def delete_thumbnail(bot, update):
    ...
    await bot.send_message(
          chat_id=update.chat.id,
          text=Translation.THUMBNAIL_DELETED,
          reply_to_message_id=update.message_id)
